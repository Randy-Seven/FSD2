...
|| (window.location.toString().indexOf('search-room-page.html') > 0) 
|| (window.location.toString().indexOf('room-details-page.html') > 0)) { // Скрипт срабатывает на определенных страницах
